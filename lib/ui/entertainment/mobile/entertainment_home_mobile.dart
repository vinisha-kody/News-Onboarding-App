...
class EntertainmentHomeMobile extends ConsumerStatefulWidget {
  const EntertainmentHomeMobile({super.key});

  @override
  ConsumerState<EntertainmentHomeMobile> createState() => _EntertainmentHomeMobileState();
}

class _EntertainmentHomeMobileState extends ConsumerState<EntertainmentHomeMobile> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SlideTransition(
        ...
        child: Column(
          children: [
            const CommonDomainImage(assetImage: AssetsLocation.heroimage),
            const CommonDomainName(domainName: "Entertainment",),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                      onTap: (){
                        ref.watch(navigationStackProvider).pushRemoveUntil(const NavigationStackItem.healthHome(), const NavigationStackItem.intro());
                      },
                      child: const CommonDislikeIcon()
                  ),
                  GestureDetector(
                      onTap: (){
                        ref.watch(navigationStackProvider).push(const NavigationStackItem.entertainmentChoice());
                      },
