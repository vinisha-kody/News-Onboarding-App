...
class ScienceHomeMobile extends ConsumerStatefulWidget {
  const ScienceHomeMobile({super.key});

  @override
  ConsumerState<ScienceHomeMobile> createState() => _ScienceHomeMobileState();
}

class _ScienceHomeMobileState extends ConsumerState<ScienceHomeMobile> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SlideTransition(
        ...
        child: Column(
          children: [
            const CommonDomainImage(assetImage: AssetsLocation.astronautes),
            const CommonDomainName(domainName: "Science",),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                      onTap: (){
                        ref.watch(navigationStackProvider).pushRemoveUntil(const NavigationStackItem.entertainmentHome(), const NavigationStackItem.intro());
                      },
                      child: const CommonDislikeIcon()
                  ),
                  GestureDetector(
                    onTap: (){
                      ref.watch(navigationStackProvider).push(const NavigationStackItem.scienceChoice());
                    },
