...
final businessProvider = ChangeNotifierProvider<BusinessController>((ref) => BusinessController());
...
class BusinessController with ChangeNotifier
{
  ...
  static List<String> businessDomainChoiceIcons=[
    AssetsLocation.economy,
    AssetsLocation.entrepreneurship,
    AssetsLocation.jobs,
    AssetsLocation.markets,
    AssetsLocation.personalfinance
  ];

  static List<String> businessDomainChoiceNames=[
    "Economy",
    "Entrepreneurship",
    "Jobs",
    "Markets",
  ...
  static List<String> businessDomainChoiceRedIcons=[
    AssetsLocation.economyred,
    AssetsLocation.entrepreneurshipred,
    AssetsLocation.jobsred,
    AssetsLocation.marketred,
    AssetsLocation.personalfinancered,
  ];
}