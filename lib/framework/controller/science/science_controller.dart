...
final scienceProvider = ChangeNotifierProvider<ScienceController>((ref) => ScienceController());

class ScienceController extends ChangeNotifier
{
  ...
  static List<String> scienceDomainChoiceIcons=[
    AssetsLocation.earth,
    AssetsLocation.dna,
    AssetsLocation.physics,
    AssetsLocation.space,
    AssetsLocation.ant
  ];

  static List<String> scienceDomainChoiceNames=[
    "Environment",
    "Genetics",
    "Physics",
    "Space",
  ...
  static List<String> scienceDomainChoiceRedIcons=[
    AssetsLocation.earthred,
    AssetsLocation.dnared,
    AssetsLocation.physicsred,
    AssetsLocation.spacered,
    AssetsLocation.antred,
  ];
